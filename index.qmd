...
1. Share whatever Google Sheet you'll be pulling from with your service account. Use the email that ends in "iam.gserviceaccount.com"
...
It's important to check if things are set up correctly
